...
async function loadPracticeText() {
    ...
    try {
        ...
        state.practiceText =
            "The quick brown fox jumps over the lazy dog every morning. Learning to type faster requires practice and consistency. Technology continues to change the way people communicate. A good keyboard can improve comfort during long sessions. Students often use computers for research and assignments. Reading books helps expand vocabulary and critical thinking. The internet connects billions of people around the world. Programming is a valuable skill in the modern digital age. Healthy habits contribute to both physical and mental wellness. Small daily improvements can lead to significant results. Artificial intelligence is transforming many industries today. Cloud computing allows access to data from anywhere. Time management is essential for achieving personal goals. Curiosity encourages exploration and lifelong learning. Exercise and proper nutrition support a strong body. Many successful projects begin with a simple idea. Creativity helps solve problems in unique and effective ways. Teamwork often leads to better outcomes than working alone. Persistence is the key to overcoming difficult challenges.";
